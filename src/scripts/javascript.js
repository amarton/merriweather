var app = app || {
	...
	share: function(){
		...
		$(".icon-twitter").on("click", function(){
			...
			var tweet = "50 years of Merriweather: A look at a concert venue’s legacy, future"; //Tweet text
		...
		$(".icon-facebook").on("click", function(){
			...
			var title = "50 years of Merriweather"; //Post title
			var description = "A look at a concert venue’s legacy, future"; //Post description
			var url = "http://data.baltimoresun.com/features/merriweather"; //Interactive URL
